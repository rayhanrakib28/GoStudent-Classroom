                            ...
                            <div className="container flex flex-col items-center gap-16 mx-auto my-16">
                                <div className="grid w-full grid-cols-3 gap-y-8">
                                    <div className="flex flex-col items-center">
                                        <h3 className="text-5xl font-extrabold leading-tight text-center"> {counterOn && <CountUp start={0} end={100} />}+</h3>
                                        <p className="text-base font-medium leading-7 text-center capitalize">total users</p>
                                    </div>
                                    <div className="flex flex-col items-center">
                                        <h3 className="text-5xl font-extrabold leading-tight text-center">{counterOn && <CountUp start={0} end={courses.length} />}</h3>
