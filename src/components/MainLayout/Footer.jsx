            ...
            <div class="container py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-16">
                    <div class="col-span-full lg:col-span-1 flex gap-4 md:block">
                        ...
                        <p className='hidden lg:block text-slate-400 text-xs mt-4'>Discover a rich array of courses, expert instructors, and a vibrant community designed to empower your learning journey and ignite the spark of success in your chosen skills.</p>
                    </div>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="mt-3 grid space-y-3">
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Courses</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Instructors</a></p>
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Partnerships</a></p>
                    ...
                    <div class="col-span-1">
                        ...
                        <div class="mt-3 grid space-y-3">
                            ...
                            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200" href="#">Student Stories</a></p>
                        ...
                        <form>
                            <div className="form-control">
                                <div className="relative">
                                    ...
                                    <a href='/login' className="btn absolute top-0 right-0 rounded-l-none">Subscribe</a>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="mt-5 lg:mt-12 flex justify-between">
                    <div class="flex justify-between items-center">
                        <p class="text-sm text-gray-400">© 2023 GoStudent. All rights reserved.</p>
                    </div>
